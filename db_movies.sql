...
--
-- Host: localhost:3306
-- Generation Time: Apr 15, 2017 at 09:21 PM
...
(19, 'Carly', 'hey!', '2017-04-13 22:00:08'),
(20, 'wewe', 'sws', '2017-04-13 22:05:25'),
(21, 'hey', 'hey', '2017-04-13 22:06:53'),
(22, 'hi', 'hey', '2017-04-13 22:07:15'),
(23, 'sjp', 'sup', '2017-04-13 22:07:21'),
(24, 'hey', 'hey', '2017-04-13 22:43:08');
...
--
-- Dumping data for table `tbl_movies2`
--

INSERT INTO `tbl_movies2` (`movies_id`, `movies_thumb`, `movies_fimg`, `movies_bimg`, `movies_title`, `movies_year`, `movies_storyline`, `movies_runtime`, `movies_trailer`, `movies_price`) VALUES
...
(29, 'TH_.jpg', '.jpg', 'noBG.jpg', 'Movie', '1994', 'movie story', '1 minute', 'none', '2'),
(30, 'TH_.jpg', '.jpg', 'noBG.jpg', 'Movie', '199', 'storyline', '1minute', 'no trailer', '30'),
(31, 'TH_nemo.jpg', 'nemo.jpg', 'noBG.jpg', 'Finding Nemo', '2000', 'finding nemo', '2 hours', 'none', '40'),
(32, 'TH_nemo.jpg', 'nemo.jpg', 'noBG.jpg', 'Nemo', '2001', 'ekrek', 'dfd', 'dfs', '34'),
(33, 'TH_nemo.jpg', 'nemo.jpg', 'noBG.jpg', 'djsd', 'dfd', 'df', 'dfdf', 'dfdf', 'dfd'),
(34, 'TH_10955703_10155162051305008_5963760098851325790_', '10955703_10155162051305008_5963760098851325790_n.j', 'noBG.jpg', 'Calry', 'qe', 'qeq', 'qe', 'qeq', 'qeeq');
...
CREATE TABLE `tbl_reviews` (
  `reviews_id` tinyint(3) UNSIGNED NOT NULL,
  `reviews_movie` varchar(100) NOT NULL,
  `reviews_name` text NOT NULL,
  `reviews_review` text NOT NULL
...
INSERT INTO `tbl_reviews` (`reviews_id`, `reviews_movie`, `reviews_name`, `reviews_review`) VALUES
(1, 'Despicable Me', 'Carly Marsh', 'Parents need to know that Despicable Me centers around a supervillain (voiced by Steve Carell) who adopts three girls for the sole purpose of infiltrating his nemesis\' house. Yes, you can expect mild insults like "stupid" and "poop" and a lot of action sequences involving high-tech weapons that blast things to smithereens, as well as some scenes that imply injury -- although no one is ever killed or seriously injured. But the most potentially disturbing aspect of the movie is the way that adoption is depicted -- at least at first.');
...
(1, 'Carly', 'Marsh', 'carlymarsh', 'password123', '1', '::1'),
(2, 'carly', 'marsh', 'carmar', 'password', '2', '::1'),
(3, 'carly', 'marsh', 'carmar', 'password', '1', '0');
...
--
-- Indexes for table `tbl_movies2`
--
ALTER TABLE `tbl_movies2`
  ADD PRIMARY KEY (`movies_id`);
...
--
ALTER TABLE `tbl_l_mc`
  MODIFY `mc_id` smallint(4) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=34;
--
...
--
ALTER TABLE `tbl_movies`
  MODIFY `movies_id` smallint(4) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=36;
--
-- AUTO_INCREMENT for table `tbl_movies2`
--
ALTER TABLE `tbl_movies2`
  MODIFY `movies_id` smallint(4) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=35;
--
...
--
ALTER TABLE `tbl_reviews`
  MODIFY `reviews_id` tinyint(3) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=25;
--
